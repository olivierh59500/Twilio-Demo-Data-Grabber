...
numberList = open('phones.txt', 'r').read().splitlines()
...
#Grab A CSRF Token and visitorSid
...
visitorSid = soupedupText.find('input', {'role': 'visitorSid'})['value']

payload = 'VisitorSid=' + visitorSid + '&CSRF=' + csrfToken_Urlized
